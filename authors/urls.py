...
urlpatterns = [
    ...
    path('profile/create/', views.ProfileChangeView.as_view(), name='profile_create'), # noqa E501
    path('profile/<int:id>/edit/', views.ProfileChangeView.as_view(), name='profile_edit'), # noqa E501
