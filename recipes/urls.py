...
urlpatterns = [
    ...
    path('recipes/api/v2/', views.RecipeAPIv2List.as_view(), name="recipes_api_v2"), # noqa E501
    path('recipes/api/v2/<int:pk>/', views.RecipeAPIv2Detail.as_view(), name="recipes_api_v2_detail"), # noqa E501
